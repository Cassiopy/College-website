		...
		<div id="page">
			<div id="content">
				<div class="post">
					...
					<div class="entry">
						<p>En esta p&aacutegina podr&aacute crear un usuario, eliminar un usuario y ver la lista de usuarios</p>
						<p>Consigna:</p>
						<p>Se pide definir las Siguientes funcionalidades:</p>
						<ul>
							<li>Agregar un nuevo usuario.</li>
							<li>Listar los usuarios registrados hasta el momento.</li>
							<li>Borrar un usuario de la lista.</li>
						</ul>
					</div>
				</div>
				<div style="clear: both;">&nbsp;</div>
